...
```{r}
starbs <- 
  readURL(paste0("https://web.archive.org/web/20240331211512/",
                 "https://www.menuism.com/restaurant-locations/",
                 "starbucks-coffee-39564"))

dd <- 
  readURL(paste0("https://web.archive.org/web/20211025021928/",
                 "http://www.menuism.com/restaurant-locations/",
                 "dunkin-donuts-181624"))

peets <- 
  readURL(paste0("https://web.archive.org/web/20240618034417/",
                 "https://www.menuism.com/restaurant-locations/",
                 "peets-coffee-tea-84051"))

panera <- 
  readURL(paste0("https://web.archive.org/web/20240617000440/",
                 "http://www.menuism.com/restaurant-locations/",
                 "panera-bread-4258"))

caribou <- 
  readURL(paste0("https://web.archive.org/web/20220814224211/",
                 "http://www.menuism.com/restaurant-locations/",
                 "caribou-coffee-164861"))

pain <- 
  readURL(paste0("https://web.archive.org/web/20231004193712/",
                 "http://www.menuism.com/restaurant-locations/",
                 "au-bon-pain-69342"))

beanleaf <- 
  readURL(paste0("https://web.archive.org/web/20220628010828/",
                 "http://www.menuism.com/restaurant-locations/",
                 "the-coffee-bean-tea-leaf-165988"))
mcD <- 
  readURL(paste0("https://web.archive.org/web/20240224131056/",
                 "http://www.menuism.com/restaurant-locations/",
                 "mcdonalds-21019"))

tim <- 
  readURL(paste0("https://web.archive.org/web/20220809051154/",
                 "https://www.menuism.com/restaurant-locations/",
                 "tim-hortons-190025"))
```
